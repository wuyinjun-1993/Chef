...
#<<cmd
        echo "bash run_full_pipeline_suggest_label.sh ${1} $2 ${remove_count} ${repeat_num} $lr ${l2_decay} ${epochs} ${batch_size} true ${i} ${isGPU} ${GPUID}"

        bash run_full_pipeline_suggest_label.sh ${1} $2 ${remove_count} ${repeat_num} $lr ${l2_decay} ${epochs} ${batch_size} true ${i} ${isGPU} ${GPUID}
