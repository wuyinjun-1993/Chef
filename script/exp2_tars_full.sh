...
python_file_list=(full_pipeline_suggest_labels full_pipeline_tars full_pipeline full_pipeline_o2u full_pipeline_active_learning full_pipeline_active_learning_entropy)
multi_strategy_list=(true false false false false false)
suffix_list=(sl${source_file_suffix} tars${source_file_suffix} infl${source_file_suffix} o2u${source_file_suffix} ac${source_file_suffix} ac2${source_file_suffix})
