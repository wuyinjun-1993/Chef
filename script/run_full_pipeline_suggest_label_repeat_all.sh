...
#			echo "${python_cmd} ${python_file}.py --lr ${derive_lr} --bz ${batch_size} --epochs ${epochs} --tlr ${lr} --norm loss --wd ${l2_decay} --dataset ${dataset_name} --model ${model}  --removed_count ${remove_count} --output_dir ${dataset_dir} --GPU --GPUID ${GPUID} ${hist_period_str} --resolve_conflict 0 ${regular_str}  > ${dataset_dir}/output_resolve_conflict_0_remove_count_${remove_count}_${i}_sl_${running_iteration}.txt 2>&1"
 ...
 #                      ${python_cmd} ${python_file}.py --lr ${derive_lr} --bz ${batch_size} --epochs ${epochs} --tlr ${lr} --norm loss --wd ${l2_decay} --dataset ${dataset_name} --model ${model}  --removed_count ${remove_count} --output_dir ${dataset_dir} --GPU --GPUID ${GPUID} ${hist_period_str} --resolve_conflict 0 ${regular_str}  > ${dataset_dir}/output_resolve_conflict_0_remove_count_${remove_count}_${i}_sl_${running_iteration}.txt 2>&1
			...
			then
				...
				echo "${python_cmd} ${python_file}.py --derived_lr ${derive_lr} --derived_epochs ${derived_epochs} --derived_bz ${derived_bz} --derived_l2 ${derived_l2} --bz ${batch_size} --epochs ${epochs} --tlr ${lr} --norm loss --wd ${l2_decay} --dataset ${dataset_name} --model ${model}  --removed_count ${remove_count} --output_dir ${dataset_dir} --GPU --GPUID ${GPUID} ${hist_period_str} --resolve_conflict 1 ${regular_str} ${suffix_str} ${tars_str} ${no_prov_str}  > ${dataset_dir}/output_resolve_conflict_1_remove_count_${remove_count}_${i}_${suffix}_${running_iteration}.txt 2>&1"
				...
				echo "${python_cmd} ${python_file}.py --derived_lr ${derive_lr} --derived_epochs ${derived_epochs} --derived_bz ${derived_bz} --derived_l2 ${derived_l2}  --bz ${batch_size} --epochs ${epochs} --tlr ${lr} --norm loss --wd ${l2_decay} --dataset ${dataset_name} --model ${model}  --removed_count ${remove_count} --output_dir ${dataset_dir} --GPU --GPUID ${GPUID} ${hist_period_str} --resolve_conflict 3 ${regular_str} ${suffix_str} ${tars_str} ${no_prov_str} > ${dataset_dir}/output_resolve_conflict_3_remove_count_${remove_count}_${i}_${suffix}_${running_iteration}.txt 2>&1"
...
#			echo "${python_cmd} ${python_file}.py --lr ${derive_lr} --bz ${batch_size} --epochs ${epochs} --tlr ${lr} --norm loss --wd ${l2_decay} --dataset ${dataset_name} --model ${model}  --removed_count ${remove_count} --output_dir ${dataset_dir}  ${hist_period_str} --resolve_conflict 0 ${regular_str}  > ${dataset_dir}/output_resolve_conflict_0_remove_count_${remove_count}_${i}_sl_${running_iteration}.txt 2>&1"
 ...
 #                     ${python_cmd} ${python_file}.py --lr ${derive_lr} --bz ${batch_size} --epochs ${epochs} --tlr ${lr} --norm loss --wd ${l2_decay} --dataset ${dataset_name} --model ${model}  --removed_count ${remove_count} --output_dir ${dataset_dir} ${hist_period_str} --resolve_conflict 0 ${regular_str}  > ${dataset_dir}/output_resolve_conflict_0_remove_count_${remove_count}_${i}_sl_${running_iteration}.txt 2>&1
			if [ "${multi_strategy}" = true ];
				...
				echo "${python_cmd} ${python_file}.py --derived_lr ${derive_lr} --derived_epochs ${derived_epochs} --derived_bz ${derived_bz} --derived_l2 ${derived_l2} --bz ${batch_size} --epochs ${epochs} --tlr ${lr} --norm loss --wd ${l2_decay} --dataset ${dataset_name} --model ${model}  --removed_count ${remove_count} --output_dir ${dataset_dir}  ${hist_period_str} --resolve_conflict 1 ${regular_str} ${suffix_str} ${tars_str} ${no_prov_str} > ${dataset_dir}/output_resolve_conflict_1_remove_count_${remove_count}_${i}_${suffix}_${running_iteration}.txt 2>&1"
				...
				echo "${python_cmd} ${python_file}.py --derived_lr ${derive_lr} --derived_epochs ${derived_epochs} --derived_bz ${derived_bz} --derived_l2 ${derived_l2}  --bz ${batch_size} --epochs ${epochs} --tlr ${lr} --norm loss --wd ${l2_decay} --dataset ${dataset_name} --model ${model}  --removed_count ${remove_count} --output_dir ${dataset_dir} ${hist_period_str} --resolve_conflict 3 ${regular_str} ${suffix_str} ${tars_str} ${no_prov_str} > ${dataset_dir}/output_resolve_conflict_3_remove_count_${remove_count}_${i}_${suffix}_${running_iteration}.txt 2>&1"
